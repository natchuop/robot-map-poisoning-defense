...
export RMPD_CHECKPOINT_METRICS_RUN_NAME="${RMPD_CHECKPOINT_METRICS_RUN_NAME:-simple_corridor}"
export RMPD_AMCL_MAP_NAME="${RMPD_AMCL_MAP_NAME:-simple_corridor}"
export RMPD_AMCL_INITIAL_POSE_X="${RMPD_AMCL_INITIAL_POSE_X:--4.5}"
export RMPD_AMCL_INITIAL_POSE_Y="${RMPD_AMCL_INITIAL_POSE_Y:-0.0}"

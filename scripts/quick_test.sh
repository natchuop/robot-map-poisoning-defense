...
# Opt-in evaluator settings for multi-robot smoke tests. Set RMPD_ENABLE_MAP_ACCURACY_EVALUATOR=true to enable it.
DEFAULT_ENABLE_MAP_ACCURACY_EVALUATOR="$(env_file_value RMPD_ENABLE_MAP_ACCURACY_EVALUATOR false)"
DEFAULT_MAP_ACCURACY_RESULTS_DIR="$(env_file_value RMPD_MAP_ACCURACY_RESULTS_DIR results/map_accuracy)"
DEFAULT_MAP_ACCURACY_YAML_CONFIG_FILE="$(env_file_value RMPD_MAP_ACCURACY_YAML_CONFIG_FILE '')"
DEFAULT_MAP_ACCURACY_START_DELAY="$(env_file_value RMPD_MAP_ACCURACY_EVALUATOR_START_DELAY_SEC 15)"
DEFAULT_MAP_ACCURACY_LOG_PERIOD="$(env_file_value RMPD_MAP_ACCURACY_LOG_PERIOD_SEC 2.0)"
DEFAULT_MAP_ACCURACY_TRIAL_ID="$(env_file_value RMPD_MAP_ACCURACY_TRIAL_ID quick_test)"
...
ENABLE_MAP_ACCURACY_EVALUATOR="${RMPD_ENABLE_MAP_ACCURACY_EVALUATOR:-$DEFAULT_ENABLE_MAP_ACCURACY_EVALUATOR}"
MAP_ACCURACY_RESULTS_DIR="${RMPD_MAP_ACCURACY_RESULTS_DIR:-$DEFAULT_MAP_ACCURACY_RESULTS_DIR}"
MAP_ACCURACY_YAML_CONFIG_FILE="${RMPD_MAP_ACCURACY_YAML_CONFIG_FILE:-$DEFAULT_MAP_ACCURACY_YAML_CONFIG_FILE}"
MAP_ACCURACY_START_DELAY="${RMPD_MAP_ACCURACY_EVALUATOR_START_DELAY_SEC:-$DEFAULT_MAP_ACCURACY_START_DELAY}"
MAP_ACCURACY_LOG_PERIOD="${RMPD_MAP_ACCURACY_LOG_PERIOD_SEC:-$DEFAULT_MAP_ACCURACY_LOG_PERIOD}"
MAP_ACCURACY_TRIAL_ID="${RMPD_MAP_ACCURACY_TRIAL_ID:-$DEFAULT_MAP_ACCURACY_TRIAL_ID}"
...
export RMPD_ENABLE_MAP_ACCURACY_EVALUATOR="$ENABLE_MAP_ACCURACY_EVALUATOR"
export RMPD_MAP_ACCURACY_RESULTS_DIR="$MAP_ACCURACY_RESULTS_DIR"
export RMPD_MAP_ACCURACY_YAML_CONFIG_FILE="$MAP_ACCURACY_YAML_CONFIG_FILE"
export RMPD_MAP_ACCURACY_EVALUATOR_START_DELAY_SEC="$MAP_ACCURACY_START_DELAY"
export RMPD_MAP_ACCURACY_LOG_PERIOD_SEC="$MAP_ACCURACY_LOG_PERIOD"
export RMPD_MAP_ACCURACY_TRIAL_ID="$MAP_ACCURACY_TRIAL_ID"
ROS_LOG_FOLLOW_PID=""
RVIZ_EXEC_PIDS=()
RVIZ_HOST_LOGS=()
RVIZ_CONFIG_PATHS=()
...
echo "Map accuracy evaluator: $ENABLE_MAP_ACCURACY_EVALUATOR (results: $MAP_ACCURACY_RESULTS_DIR)"
echo "Repo: $REPO_DIR"
...
if [ "$TEST_MODE" = "amcl" ]; then
  ...
  docker_compose run -d \
    ...
    -e RMPD_ENABLE_MAP_ACCURACY_EVALUATOR="${RMPD_ENABLE_MAP_ACCURACY_EVALUATOR:-$DEFAULT_ENABLE_MAP_ACCURACY_EVALUATOR}" \
    -e RMPD_MAP_ACCURACY_RESULTS_DIR="${RMPD_MAP_ACCURACY_RESULTS_DIR:-$DEFAULT_MAP_ACCURACY_RESULTS_DIR}" \
    -e RMPD_MAP_ACCURACY_YAML_CONFIG_FILE="${RMPD_MAP_ACCURACY_YAML_CONFIG_FILE:-$DEFAULT_MAP_ACCURACY_YAML_CONFIG_FILE}" \
    -e RMPD_MAP_ACCURACY_EVALUATOR_START_DELAY_SEC="${RMPD_MAP_ACCURACY_EVALUATOR_START_DELAY_SEC:-$DEFAULT_MAP_ACCURACY_START_DELAY}" \
    -e RMPD_MAP_ACCURACY_LOG_PERIOD_SEC="${RMPD_MAP_ACCURACY_LOG_PERIOD_SEC:-$DEFAULT_MAP_ACCURACY_LOG_PERIOD}" \
    -e RMPD_MAP_ACCURACY_TRIAL_ID="${RMPD_MAP_ACCURACY_TRIAL_ID:-$DEFAULT_MAP_ACCURACY_TRIAL_ID}" \
    ros2 bash scripts/start_ros2_stack.sh >/dev/null
fi

...
export RMPD_MAP_ID="two_route"
export RMPD_CHECKPOINT_METRICS_RUN_NAME="${RMPD_CHECKPOINT_METRICS_RUN_NAME:-two_route}"
export RMPD_AMCL_MAP_NAME="${RMPD_AMCL_MAP_NAME:-two_route}"
export RMPD_AMCL_INITIAL_POSE_X="${RMPD_AMCL_INITIAL_POSE_X:--4.5}"
export RMPD_AMCL_INITIAL_POSE_Y="${RMPD_AMCL_INITIAL_POSE_Y:-1.0}"
export RMPD_AMCL_INITIAL_POSE_YAW="${RMPD_AMCL_INITIAL_POSE_YAW:-0.0}"

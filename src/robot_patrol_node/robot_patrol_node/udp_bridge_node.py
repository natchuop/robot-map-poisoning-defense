...
class UdpBridgeNode(Node):
    def __init__(self) -> None:
        ...
        self.min_publish_period_ns = int(1_000_000_000 / max(self.max_publish_hz, 1.0))

        self.scan_pub = self.create_publisher(LaserScan, '/scan', 10)
        self.pose_pub = self.create_publisher(Pose2D, '/robot_pose', 10)
        self.checkpoint_contact_pub = self.create_publisher(String, '/webots_checkpoint_contact', 10)

...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument('lidar_quality_near_m', default_value='1.25'),
            DeclareLaunchArgument('lidar_quality_far_m', default_value='4.0'),
            DeclareLaunchArgument('min_observation_quality', default_value='0.15'),
            DeclareLaunchArgument('max_free_clear_range_m', default_value='3.0'),

...
def _belief_node(robot: dict, all_robot_ids: list[str]) -> Node:
    ...
    return Node(
        ...
        parameters=[{
            ...
            'local_map_topic': _robot_topic(robot_id, 'live_map'),
            'local_confidence_topic': _robot_topic(robot_id, 'confidence_map'),
            'map_updates_topic': '/map_updates',
            'shared_map_topic': _robot_topic(robot_id, 'shared_live_map'),
            'occupied_confidence_map_topic': _robot_topic(robot_id, 'occupied_confidence_map'),
            'clear_confidence_map_topic': _robot_topic(robot_id, 'clear_confidence_map'),
            'shared_confidence_topic': _robot_topic(robot_id, 'shared_confidence_map'),
            'confidence_marker_topic': _robot_topic(robot_id, 'confidence_markers'),
            'trust_table_json': robot['trust_table_json'],
            'unknown_robot_trust': 0.50,
            'unknown_robot_trust_confidence': 0.10,
            'local_occupied_weight': 1.00,
            'local_clear_weight': 1.00,
            'remote_evidence_scale': 1.00,
            'min_total_evidence': 0.30,
            'occupied_threshold': 0.70,
            'clear_threshold': 0.70,
            'disputed_margin': 0.20,
        }],
    )
